...
export class ObstacleManager {
  ...
  private spawnObstacle(
    ...
    if (this.activeLevelConfig) {
      ...
      // Enable special different-direction split opening animation specifically for all obstacles in Levels 1-20 (excluding Level 11, 2, 4, 5, 6, 7, 8, 10), special legacy levels, and the Chrono Warp Miniboss Group 1
      const isSpecialSplit = 
        (levelNum !== undefined && levelNum >= 1 && levelNum <= 20 && levelNum !== 11 && levelNum !== 2 && levelNum !== 4 && levelNum !== 5 && levelNum !== 6 && levelNum !== 7 && levelNum !== 8 && levelNum !== 10) ||
