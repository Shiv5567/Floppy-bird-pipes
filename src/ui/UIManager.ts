      ...
      case 'rewards': {
          ...
          return `
            <div class="daily-rewards-container" style="padding-bottom: 20px;">
              <div class="hangar-section-title" style="margin: 0 0 15px 0; font-size: 12px; font-weight: 900; letter-spacing: 1px; text-transform: uppercase; color: #fff; text-shadow: 0 0 8px rgba(255,255,255,0.4); text-align: center;">🎯 MISSION PROGRESS</div>
