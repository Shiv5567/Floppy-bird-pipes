...
export class LevelManager {
  ...
  static {
    ...
    // Swap Level Configurations (Option 2: 40-44 exchanged with 46-50, 45 in the middle; Level 3 and Level 50 exchanged)
    const swapPairs = [
      [40, 46],
      [41, 47],
      [42, 48],
    ...
    // Reduce Level 3 and Level 4 path gap by 30%
